...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... urls) {
            ...
            String[] simpleWeatherData;
            try {
                 weatherResponse = NetworkUtils.getResponseFromHttpUrl(url);

                 simpleWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResponse);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        @Override
        protected void onPostExecute(String[] weatherDatum) {
            if (weatherDatum != null) {
                for (String weatherData : weatherDatum) {
